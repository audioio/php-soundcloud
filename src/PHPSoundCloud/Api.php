...
use \PHPSoundCloud\Exception\InvalidHttpResponseCode as InvalidHttpResponseCodeException;
...
class Api
{
     ...
     *
     * @return void
     * @throws \PHPSoundCloud\Exception\MissingClientId
     *
     * @access public
     */
     ...
     *
     * @return string
     * @throws \PHPSoundCloud\Exception\UnsupportedAudioFormat
     *
     * @access public
     */
     ...
     *
     * @return object
     * @throws \PHPSoundCloud\Exception\UnsupportedResponseFormat
     *
     * @access public
     */
    ...
    {
        return self::$_userAgent . '/' . new \PHPSoundCloud\Version;
    }
     ...
     *
     * @return mixed
     * @throws PHPSoundCloud\Exception\InvalidHttpResponseCode
     *
     * @access protected
     */
